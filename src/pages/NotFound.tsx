...
export default function NotFound() {
  return (
    <div className="w-full h-[70vh] flex flex-col items-center justify-center text-center px-4">
      ...
      <h2 className="text-3xl font-bold uppercase tracking-wider mb-8">Page Not Found</h2>
      ...
      <Link to="/" className="bg-white text-black font-bold uppercase tracking-widest px-8 py-4 rounded-full hover:bg-gray-200 transition-colors">
        Return Home
      </Link>
    </div>
  );
